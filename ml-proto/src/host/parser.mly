...
%token ASSERTINVALID ASSERTEQ ASSERTEQBITS ASSERTNAN ASSERTFAULT INVOKE
%token EOF
...
cmd :
  ...
  | LPAR ASSERTEQBITS LPAR INVOKE TEXT expr_list RPAR expr RPAR
    { AssertEqBits ($5, $6 (c0 ()), $8 (c0 ())) @@ at() }
